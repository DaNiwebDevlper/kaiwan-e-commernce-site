        ...
        <div className="relative flex justify-center items-center min-h-[70vh] mt-[100px]">
            <div className=' min-h-[50vh] flex sm:items-center items-end p-5 bg-gradient-to-br from-red-300 to-red-100 w-[80%] rounded-xl shadow-md '>
                <div className="sm:pl-9">
                    ...
                    <p className='text-sm text-rose-700 pb-5 pt-2'>For glowing skin try this product that make you more bright.</p>
                ...
                <Image loading='lazy' src="/assets/banner.png" width={300} height={500} alt='banner' className=' absolute sm:right-[150px] right-11  sm:top-[-70px] top-[-60px] sm:w-[300px] w-[200px] h-[230px] sm:h-[350px]' />
            </div>
        </div>
    )
}
